    ...
    for index2, char2 in enumerate(secondString):
        ...
        for index1, char1 in enumerate(firstString):
            if char1 == char2:
                ...
                minime = min((distances[index1],
                              distances[index1+1],
                              newDistances[-1]))
                newDistances.append(1 + minime)
...
def extractKeyphrases(text):
    ...
    # this will be used to determine adjacent words
    # in order to construct keyphrases with two words
    ...
    # the number of keyphrases returned will be relative
    # to the size of the text
    aThird = len(word_set_list) // 3
    keyphrases = keyphrases[0:aThird+1]

    # take keyphrases with multiple words
    # into consideration as done in the paper if two words are adjacent
    # in the text and are selected as keywords, join them together
    modifiedKeyphrases = set()

    # keeps track of individual keywords
    # that have been joined to form a keyphrase
    dealtWith = set()
    ...
    while j < len(textlist):
        ...
        if firstWord in keyphrases and secondWord in keyphrases:
            ...
            if j == (len(textlist) - 1) and secondWord in keyphrases:
                if secondWord not in dealtWith:
